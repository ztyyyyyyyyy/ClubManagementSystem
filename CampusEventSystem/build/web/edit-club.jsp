...
<%@ page import="com.campus.model.Club" %>
<%
    ...
    // Get club ID and load club data
    ...
    if (club == null) {
        response.sendRedirect("admin.jsp?section=clubs&error=Club not found");
        return;
    }
%>
<!DOCTYPE html>
...
<head>
    ...
    <title>Edit Club - Campus Management System</title>
...
<body class="flex flex-col min-h-screen">
    <header class="admin-header-bg text-white px-8 py-4 flex justify-between items-center shadow-lg sticky top-0 z-10">
        <h1 class="text-3xl font-extrabold tracking-wide">Edit Club</h1>
        <a href="admin.jsp?section=clubs" class="bg-yellow-300 text-purple-800 hover:bg-yellow-400 px-5 py-2 rounded-full text-lg font-semibold transition-all duration-300 ease-in-out shadow-md">
            Back to Clubs
        </a>
    </header>
    ...
    <main class="flex-grow max-w-2xl mx-auto p-6 w-full flex flex-col items-stretch">
        <section class="section-card">
            <h2 class="text-3xl font-extrabold text-blue-800 mb-8 text-center">Edit Club Details</h2>
            ...
            <form method="post" action="AdminServlet">
                ...
                <div class="mb-6">
                    <label for="clubName" class="block text-lg font-semibold text-gray-800 mb-2">Club Name <span class="text-red-500">*</span></label>
                ...
                <div class="mb-8">
                    ...
                    <textarea id="description" name="description" rows="6" 
                              class="form-input resize-y"><%= club.getDescription() != null ? club.getDescription() : "" %></textarea>
                </div>
                
                <div class="flex justify-end space-x-4">
                    <a href="admin.jsp?section=clubs" class="btn-secondary">Cancel</a>
