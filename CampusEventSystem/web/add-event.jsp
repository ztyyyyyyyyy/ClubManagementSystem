...
<head>
    ...
    <title>Add Event - Campus Management System</title>
...
<body>
    <header class="page-header-bg text-white px-8 py-4 flex justify-between items-center shadow-lg sticky top-0 z-10">
        <h1 class="text-3xl font-extrabold tracking-wide">Add New Event</h1>
        <a href="admin.jsp?section=events" class="text-white hover:text-[#FEFF9F] font-semibold transition-colors duration-300 ease-in-out text-lg">
            Back to Events
        </a>
    </header>
    ...
    <main class="flex-grow max-w-xl mx-auto p-6 w-full flex flex-col items-stretch">
        <div class="form-container-card">
            <h2 class="text-3xl font-extrabold text-indigo-700 mb-8 text-center">Create a New Campus Event</h2>
            ...
            <form method="post" action="AdminServlet">
                ...
                <div class="mb-4">
                    <label for="eventDate" class="block text-sm font-medium text-gray-700 mb-2">Event Date <span class="text-red-500">*</span></label>
                    <input type="date" id="eventDate" name="eventDate" required 
                           class="w-full"
                           value="<%= request.getParameter("eventDate") != null ? request.getParameter("eventDate") : "" %>">
                </div>
                ...
                <div class="flex justify-end space-x-4">
                    <a href="admin.jsp?section=events" class="cancel-btn flex items-center justify-center">
                        Cancel
                    </a>
